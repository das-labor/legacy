...
\begin{center}
        \includegraphics[width=9cm]{images/bild02.jpg}
\end{center}
...
\pause
\begin{itemize}
    \item $p_w$ ist üblicherweise $1$
    \pause
    \item Uniforme Behandlung von geometrischen Transformationen durch eine $4 \times 4$ Matrix
    \pause
    \item komplexe Transformationen können durch die Kombination von elementaren 
...
\begin{itemize}
\item Alle Punkte müssen auf einer Ebene liegen.
\pause
...
\subsection{Objekte miteinander verknüpfen}

\begin{frame}
\frametitle{Pivotpunkt}
\begin{itemize}
\item Der Pivotpunkt dient als Ausgangspunkt für Transformationen. 
\end{itemize}
