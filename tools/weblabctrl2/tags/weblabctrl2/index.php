...
<a href="/weblabctrl2.5/index.php">BetaVersion 2.5</a>
<div id="status"> </div>
...
<a href="http://twitter.com/Laboranten">laboranten@twitter</a><br>
<input type="text"  onchange="text_the_borg(this.value);text_the_twitter(this.value);this.value='';" value="">
Laufschriftborg<br>
