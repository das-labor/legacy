...
$canir_beamer_a=array("suspend" => "0x00", "source" => "0x01", "vga" => "0x02", "dvi" => "0x03" , "svideo" => "0x04", "video" => "0x05" , "component" => "0x06", "blank" => "0x07");
$canir_teufel_a=array("leiser" => "0x00", "lauter" => "0x01", "mute" => "0x02", "main" => "0x03" , "front" => "0x04", "rear" => "0x05" , "side" => "0x06", "sub" => "0x07", "center" => "0x08");
