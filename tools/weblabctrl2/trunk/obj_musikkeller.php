...
class c_musikkeller extends c_content{
  protected $dname;
  protected $actorfile="act_musikkeller.php";
  protected $updaterfile="updt_musikkeller.php";
  protected $content;
  protected $divstr;
  protected $cssstr;
  protected $setfile;
  ...
  {
    $this->setobjname("musikkeller");
    $this->setdisplayname("Musik Keller");
    $this->setsetFile("act_musikkeller.php");
    $this->setsetfilecmd("musikkeller");
    $this->setid("id_musikkeller");
  }
  ...
  protected function initContent()
  {
    ...
    $this->content .= "<div name=\"".$this->myid."link\" id=\"".$this->myid."link\" style=\"font-size:small\"> <a href=\"http://wl/keller/index.php\">webinterface</a></div>";
  ...
  public function getupdaterjs()
  {
    ...
    if( ( !isset($localstate["musik_keller_last"])) ||
	($localstate["musik_keller_last"]+10 < time()) || 
	(!isset($localstate["musik_keller_status"])) )
    {
      unset($status);
      ...
      $localstate["musik_keller_title"] = $status[0];
      ...
      if(strcmp($status[0],$titel)==0) 
	{
	  ...
	  $localstate["musik_keller_status"]=substr($indata[0],1,-1);
	  $localstate["musik_keller_current"]=$indata[2].":".$indata[3];
	  $localstate["musik_keller_end"]=$indata[4].":".$indata[5];
	  $localstate["musik_keller_pos"]=$indata[6];
	}
      else 
	{
	  $localstate["musik_keller_current"]="0:0";
	  $localstate["musik_keller_end"]="0:0";
	  $localstate["musik_keller_pos"]=0;
	  $localstate["musik_keller_status"]="stop";
	}
      $localstate["musik_keller_volume"]=$volume[0];
      $localstate["musik_keller_last"]=time();
    }
    ...
    $updaterjs .= $this->myid."_obj_slider_vol.setValue('".$localstate["musik_keller_volume"]."');\n";
    $updaterjs .= $this->myid."_obj_slider_seek.setValue('".$localstate["musik_keller_pos"]."');\n";
    $updaterjs .= $this->myid."settitle(\"".htmlspecialchars($localstate["musik_keller_title"])."\");\n";
    $updaterjs .= $this->myid."setplaypos(\"".htmlspecialchars($localstate["musik_keller_current"])."/".htmlspecialchars($localstate["musik_lounge_end"])."\");\n";
