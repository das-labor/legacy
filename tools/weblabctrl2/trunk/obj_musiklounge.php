...
class c_musiklounge extends c_content{
  ...
  protected function initContent()
  {
    ...
    $this->content .= "<div name=\"".$this->myid."link\" id=\"".$this->myid."link\" style=\"font-size:small\"> <a href=\"http://wl/lounge/index.php\">webinterface</a></div>";
...
#    $this->cssstr .= "  background-color:#f00; \n";
  ...
  public function getupdaterjs()
  {
	...
	unset($status);
	exec("MPD_PORT=6600 mpc volume",$status);
