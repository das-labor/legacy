  ...
  protected function initContent()
  {
	...
	if ($subdir !== "." && $subdir !== ".."){
	  ...
	  for($i=0;$i < sizeof($this->validstages); $i++){
	      $this->content .= "<input type=\"image\" src=\"icons/p.png\" onclick=\"".$this->myid."_cmd('".$subdir."',document.getElementsByName('".$subdir."')[0].options[document.getElementsByName('".$subdir."')[0].options.selectedIndex].value,'".$this->validstages[$i]."');\">";
	  }
