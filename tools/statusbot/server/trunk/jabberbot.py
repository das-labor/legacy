...
################################
    ...
    def callback_keepalive(self):
        """
        Function which is called every 60seconds to keep the connection alive.
        normaly we just send our status.
        """
        self._send_status()
    ...
    def set_show(self,value):
        self.__set_show(value)

    def __get_show(self):
        return self.__show

    def get_show(self):
        return self.__get_show()
