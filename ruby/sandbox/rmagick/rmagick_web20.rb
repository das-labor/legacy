...
color = Image.new(combined_grad.columns, combined_grad.rows) {self.background_color = "#87a5ff"}
...
gc.annotate(background, 0, 0, 25, HEIGHT+3, "RUBY")

reflection = stripes[1].flip
reflection.composite!(color, CenterGravity, ColorizeCompositeOp)
gc.annotate(reflection, 0, 0, 25, HEIGHT+3, "RUBY")
