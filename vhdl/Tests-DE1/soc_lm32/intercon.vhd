...
--   sram0
--     baseadr 0x00001000 - size 0x00080000
-----------------------------------------------------------------------------------------
library IEEE;
...
'0';
lm32i_sram0_ss <= '1' when lm32i_adr_o(31 downto 19)="0000000000000" else 
'0';
...
'0';
lm32d_sram0_ss <= '1' when lm32d_adr_o(31 downto 19)="0000000000000" else 
'0';
