...
bool KeyronaSubject::loadSubject(string &subjectIdentifier)
{
    ...
    mySubjectKey = new KeyronaKey(mySubjectKeyfile, mySubjectName);
    return true;
};
...
bool KeyronaSubject::storeSubject()
{
    ...
    vector<UInt8> passwordMagicVector = convertStringToUInt8Vector(mySubjectIDString);
    passwordMagicVector = encryptForSubject(passwordMagicVector);
    string myBase64EncodedPasswordMagicVector = EncodeUInt8VectorToBASE64(&passwordMagicVector);
...
bool KeyronaSubject::verifyPassword(string &myPassword)
{
    ...
    vector<UInt8> myPasswordMagicVector = DecodeBASE64StringToUInt8Vector(myBase64EncodedPasswordMagicVector);
    ...
    myPasswordMagic = convertUInt8VectorToString(&myPasswordMagicVector);
