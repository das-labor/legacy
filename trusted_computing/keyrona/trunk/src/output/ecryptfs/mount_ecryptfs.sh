...
/bin/mount -t ecryptfs ${args[0]} ${args[1]} -o key=passphrase:passwd=${args[2]} -o ecryptfs_cipher=aes -o ecryptfs_key_bytes=32 -o ecryptfs_passthrough -o no_sig_cache 2>> ${logfile} 1>> ${logfile}
check_result $?
