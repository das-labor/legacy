...
namespace keyrona
{
    ...
    class KeyronaTPM
    {
	     ...
	     */
            vector<ByteVector> bind(ByteVector &dataToBind, int &bindkeynum);
           
            /*!
             *  @brief  not implemented yet 
	     */
	   ByteVector unbind(vector<ByteVector> &dataToUnbind, int &bindkeynum, string &password);
	     ...
	     */
	    vector<ByteVector> create_key(string &password, int &keynum, int &type);
	    
	    vector<ByteVector> change_key_auth(string &password, string &password_old, int &keynum);
	    
	    vector<ByteVector> delete_key(int &keynum);
