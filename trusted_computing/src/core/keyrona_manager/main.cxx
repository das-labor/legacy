...
{
        cout << "========================================================================"<< endl;
	cout << "                     Keyrona Manager " << string(VERSION) << endl;
	...
	try 
	{
		...
		{
			cout << parser.getBriefHelp( "Keyrona Manager" ) << endl;
		...
		if (configFileOption.hasValue())
		{
                ...
                {
                    KeyronaInit( initOption.getValue(), myKeyronaConfig );
                    return SUCCESS;
                }

		if ( userOption.hasValue() )
                {
                    KeyronaUserManagement( userOption.getValue(), myKeyronaConfig );
                    return SUCCESS;
                }

		if ( groupOption.hasValue() )
                {
                    KeyronaGroupManagement( groupOption.getValue(), myKeyronaConfig );
                    return SUCCESS;
                }
		...
		if ( platformOption.hasValue() )
                {
                    KeyronaPlatformManagement( platformOption.getValue(), myKeyronaConfig );
                    return SUCCESS;
                }
		if ( tokenOption.hasValue() )
                {
                    KeyronaTokenManagement( tokenOption.getValue(), myKeyronaConfig );
                    return SUCCESS;
                }
