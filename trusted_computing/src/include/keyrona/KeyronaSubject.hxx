...
namespace keyrona
{
    ...
    class KeyronaSubject
    {
	     ...
	     */
	    ByteVector      encryptForSubject(KeyronaSubject *Subject, ByteVector &toEncrypt);
	     ...
	     */
	    ByteVector      decryptBySubject(KeyronaSubject *Subject, ByteVector &toDecrypt, string &myPassword);
