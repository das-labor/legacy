...
#ifndef _TPMCRYPTDATE_HXX
#define	_TPMCRYPTDATE_HXX
...
namespace keyrona
{
    class TpmCryptDate
    {
        public:
             ...
             */
            TpmCryptDate(UInt32 year, UInt32 month, UInt32 day, UInt32 hour, UInt32 minute, UInt32 second);
            
            /*!
             *  @brief get date directly by vector
             *  @param date, vector of UInt32, contains the date
             */      
            TpmCryptDate(vector<UInt32> date);
