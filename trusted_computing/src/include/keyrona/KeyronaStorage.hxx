...
#ifndef _KEYRONASTORAGE_HXX
#define _KEYRONASTORAGE_HXX

#include <Keyrona.hxx>

// Database entries
const std::string KeyronaDatabase_SectionIdentifier_Start       =	"<Section>";
const std::string KeyronaDatabase_SectionIdentifier_Stop        =	"</Section>";
const std::string KeyronaDatabase_SectionNameIdentifier         =       "SectionName";
const std::string KeyronaDatabase_SubSectionIdentifier_Start    =	"<SubSection>";
const std::string KeyronaDatabase_SubSectionIdentifier_Stop     =	"</SubSection>";
const std::string KeyronaDatabase_SubSectionNameIdentifier      =       "SubSectionName";
const std::string KeyronaDatabase_EntryIdentifier_Start         =	"<Entry>";
const std::string KeyronaDatabase_EntryIdentifier_Stop          =	"</Entry>";
const std::string KeyronaDatabase_EntryNameIdentifier           =	"EntryName";
const std::string KeyronaDatabase_ValueIdentifier               =	"Value";
...
namespace keyrona
{
    class KeyronaStorage
    {
        public:
	    /*!
             *  @brief constructor for a KeyronaStorage object
	     ...
	     */
            KeyronaStorage( const string &StorageName, const string &StorageFile );
            KeyronaStorage( const string &StorageName, const string &StorageFile, bool clear);
         ...
         */
        KeyronaStorage( const KeyronaStorage& );

        /*!
         *  @brief  disabled assignment operator
         */
        KeyronaStorage& operator=( const KeyronaStorage& );
