...
const std::string user_keys = "CREATE TABLE IF NOT EXISTS user_keys(uuid INTEGER PRIMARY KEY ASC, u_uuid INTEGER NOT NULL,v_uuid INTEGER NOT NULL, key_uuid INTEGER NOT NULL, key_blob BLOB NOT NULL)";
...
const std::string volumes_users = "CREATE TABLE IF NOT EXISTS volumes_users(v_uuid INTEGER PRIMARY KEY, u_uuid INTEGER NOT NULL)";
const std::string volumes_sss = "CREATE TABLE IF NOT EXISTS volumes_sss(v_uuid INTEGER PRIMARY KEY, sss_uuid INTEGER NOT NULL)";
...
namespace tpmcrypt
{
    class TpmCryptStorage
    {
        ...
        void deleteDB(string &table, string &column, string &identifier);
        
        void deleteAllEntryDB(string &column, string &identifier);
