...
/**
 * @file        TpmCryptTPM.hxx
 * @brief       Implementation of the TpmCrypt TPM class.
 * @version     $Revision: 779 $
 * @date        Last modification at $Date: 2009-07-31 15:20:20 +0200 (Fri, 31 Jul 2009) $ by $Author: selhorst $
 */

#ifndef _TPMCRYPTTPM_HXX
#define	_TPMCRYPTTPM_HXX

#include <TpmCrypt.hxx>

const std::string TPMCRYPT_TPM_DATA_EXTENSION            =".TPMDATA";
const std::string TPMCRYPT_TPM_KEY_EXTENSION             =".TPMKEY";
    ...
    class TpmCryptTPM
    {
	   ...
	   ByteVector unbind(ByteVector &dataToUnbind, UInt32 &bindkeynum, string &password);
        ...
        private:
             ...
             */
            TpmCryptTPM ( const TpmCryptTPM& );

            /*!
             *  @brief  disabled assignment operator
             */
            TpmCryptTPM& operator=( const TpmCryptTPM& );
    };
};


#endif	/* _TPMCRYPTTPM_HXX */
