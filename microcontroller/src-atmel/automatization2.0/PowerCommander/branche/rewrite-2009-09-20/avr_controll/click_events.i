	...
	for(taster_i=0;taster_i<U_COUNT;taster_i++)
		{
			...
			*/
			if ( rb[taster_i].tastercounter > rb[taster_i].tastercounter_last) {
				rb[taster_i].clickstate[rb[taster_i].clickpos]++;
				rb[taster_i].tastercounter_last=rb[taster_i].tastercounter;
			}
			else {
				/* 
				...
				*/
				...
				/*
					ring-buffer - 
				*/
				if ((rb[taster_i].clickstate_free[rb[taster_i].clickpos] > T_CLICKTHRESHOLD) && 
						(rb[taster_i].clickstate[rb[taster_i].clickpos] > T_CLICKTHRESHOLD) )
					{
						rb[taster_i].clickpos++;
						rb[taster_i].clickstate[rb[taster_i].clickpos]=0;
						rb[taster_i].clickstate_free[rb[taster_i].clickpos]=0;
						rb[taster_i].tastercounter=0;
						rb[taster_i].tastercounter_last=0;
					}
				/*
