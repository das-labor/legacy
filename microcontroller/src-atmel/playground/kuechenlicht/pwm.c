...
static volatile uint8_t color[3] = {0, 0, 0}; 
...
void fadeto(uint8_t r, uint8_t g, uint8_t b, uint8_t steps)
{
	static uint16_t i;
	...
	addColor[0] = ((r*128)-helpColor[0])/(int16_t)steps;
	addColor[1] = ((g*128)-helpColor[1])/(int16_t)steps;
	addColor[2] = ((b*128)-helpColor[2])/(int16_t)steps;
