...
typedef enum { PORT_MGT=0x30, PORT_LAMPE=0x20, PORT_SDO=0x15, PORT_SDO_DATA=0x16,
		PORT_BORG=0x23, PORT_MOOD=0x17, PORT_REMOTE=0x21, PORT_TEMP=0x23 }       	ports;

typedef enum { FKT_MGT_PING=0x00, FKT_MGT_PONG=0x01, 
		FKT_MGT_RESET=0x02, FKT_MGT_AWAKE=0x03, FKT_MGT_DESC=0x04, FKT_MGT_WRADR=0x05, FKT_MGT_ADDSENSOR }	lap_mgt_fkts;
...
typedef enum { FKT_MOOD=0x00, FKT_MOOD_GET_B=0x01, FKT_MOOD_SET_B=0x02, FKT_SPEED=0x03} lap_mood_fkts;
