...
#define UART_RTS			UART_RTS_PORT &= ~(_BV(UART_RTS_BIT))
#define UART_NO_RTS 		UART_RTS_PORT |= _BV(UART_RTS_BIT)
...
#ifdef UART_HWFLOWCONTROL
	UART_CTS_DDR &= ~(_BV(UART_CTS_BIT));
	UART_RTS_DDR |= _BV(UART_RTS_BIT);
	UART_RTS;
#endif
