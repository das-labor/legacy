...
unsigned char colorTable[MAX_Z][MAX_Y][MAX_X];

#define MAX_BRIGHTHNES 100
#define MAX_PLANES       5
#define MAX_PLANEBYTES  10

unsigned char pixmap[MAX_BRIGHTHNES][MAX_PLANES][MAX_PLANEBYTES];
