...
uint16_t fire_frequency = 20;


int16_t simmer_i_soll = 100;
int16_t power_u_soll = 1400;
...
void update_menu(){
	...
	if(selected == 0){
		simmer_i_soll += enc;
		if(simmer_i_soll > MAX_SIMMER_I){
			simmer_i_soll = MAX_SIMMER_I;
