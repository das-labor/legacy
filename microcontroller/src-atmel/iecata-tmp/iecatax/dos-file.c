...
bool_t openRead (char *pattern, uint8_t fileType,
                               uint8_t channel) {
...
bool_t openWrite (char *name, uint8_t fileType,
                                uint8_t channel) {
  struct dirEntryStruct *entry;
  struct channelTableStruct *channelStruct = &channelTable[channel];
...
bool_t writeFile (struct channelTableStruct *channelStruct) {
