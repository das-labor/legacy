...
static menucommon_s *g_weapons_controls[] = {
	...
	(menucommon_s *)&s_controls.foamgun,
	NULL,
};
...
static void Controls_UpdateModel( int anim ) {
	...
	case ANIM_WEAPON11:
		s_controls.playerWeapon = WP_FOAMGUN;
		break;
...
static void Controls_MenuInit( void )
{
	...
	s_controls.foamgun.generic.type	     = MTYPE_ACTION;
	s_controls.foamgun.generic.flags     = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.foamgun.generic.callback  = Controls_ActionEvent;
	s_controls.foamgun.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.foamgun.generic.id        = ID_WEAPON11;
	...
	Menu_AddItem( &s_controls.menu, &s_controls.foamgun );
