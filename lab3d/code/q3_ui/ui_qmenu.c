...
void Menu_Cache( void )
{
	...
	menu_in_sound	= trap_S_RegisterSound( "sound/click.wav", qfalse );
	menu_move_sound	= trap_S_RegisterSound( "sound/click.wav", qfalse );
	menu_out_sound	= trap_S_RegisterSound( "sound/click.wav", qfalse );
	menu_buzz_sound	= trap_S_RegisterSound( "sound/click.wav", qfalse );
	weaponChangeSound	= trap_S_RegisterSound( "sound/click.wav", qfalse );
