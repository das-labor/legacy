...
void CG_RegisterWeapon( int weaponNum ) {
	...
	case WP_GAUNTLET:
		...
		weaponInfo->firingSound = trap_S_RegisterSound( "sound/click.wav", qfalse );
		weaponInfo->flashSound[0] = trap_S_RegisterSound( "sound/click.wav", qfalse );
		break;

	case WP_LIGHTNING:
		MAKERGB( weaponInfo->flashDlightColor, 0.6f, 0.6f, 1.0f );
		weaponInfo->readySound = trap_S_RegisterSound( "sound/click.wav", qfalse );
		weaponInfo->firingSound = trap_S_RegisterSound( "sound/click.wav", qfalse );

		weaponInfo->flashSound[0] = trap_S_RegisterSound( "sound/click.wav", qfalse );
		cgs.media.lightningShader = trap_R_RegisterShader( "lightningBoltNew");
		cgs.media.lightningExplosionModel = trap_R_RegisterModel( "models/weaphits/crackle.md3" );
		cgs.media.sfx_lghit1 = trap_S_RegisterSound( "sound/click.wav", qfalse );
		cgs.media.sfx_lghit2 = trap_S_RegisterSound( "sound/click.wav", qfalse );
		cgs.media.sfx_lghit3 = trap_S_RegisterSound( "sound/click.wav", qfalse );
	...
	case WP_CHAINGUN:
		...
		weaponInfo->flashSound[0] = trap_S_RegisterSound( "sound/click.wav", qfalse );
		weaponInfo->flashSound[1] = trap_S_RegisterSound( "sound/click.wav", qfalse );
		weaponInfo->flashSound[2] = trap_S_RegisterSound( "sound/click.wav", qfalse );
		weaponInfo->flashSound[3] = trap_S_RegisterSound( "sound/click.wav", qfalse );
...
static float	CG_MachinegunSpinAngle( centity_t *cent ) {
	...
	if ( cent->pe.barrelSpinning == !(cent->currentState.eFlags & EF_FIRING) ) {
		...
		if ( cent->currentState.weapon == WP_CHAINGUN && !cent->pe.barrelSpinning ) {
			trap_S_StartSound( NULL, cent->currentState.number, CHAN_WEAPON, trap_S_RegisterSound( "sound/click.wav", qfalse ) );
		}
#endif
	}
